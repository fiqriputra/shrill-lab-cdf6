...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-lab-cdf6
```

A live public deployment of this template is available at [https://shrill-lab-cdf6.templates.workers.dev](https://shrill-lab-cdf6.templates.workers.dev)
